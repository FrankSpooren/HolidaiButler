-- =====================================================
-- Ticketing Module - Database Migration
...
CREATE TABLE IF NOT EXISTS `bookings` (
  ...
  `poi_id` VARCHAR(36) NOT NULL COMMENT 'Reference to pois table',
  ...
  -- Tickets
  `ticket_ids` JSON NULL DEFAULT (JSON_ARRAY()) COMMENT 'Array of ticket UUIDs',
  ...
  CONSTRAINT `fk_bookings_poi` FOREIGN KEY (`poi_id`) REFERENCES `pois`(`id`) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS `tickets` (
  ...
  `booking_id` VARCHAR(36) NOT NULL COMMENT 'Reference to bookings table',
  `user_id` VARCHAR(36) NOT NULL COMMENT 'Reference to users table',
  `poi_id` VARCHAR(36) NOT NULL COMMENT 'Reference to pois table',
  ...
  CONSTRAINT `fk_tickets_poi` FOREIGN KEY (`poi_id`) REFERENCES `pois`(`id`) ON DELETE CASCADE
...
CREATE TABLE IF NOT EXISTS `availability` (
  ...
  -- Foreign Keys
  CONSTRAINT `fk_availability_poi` FOREIGN KEY (`poi_id`) REFERENCES `pois`(`id`) ON DELETE CASCADE
