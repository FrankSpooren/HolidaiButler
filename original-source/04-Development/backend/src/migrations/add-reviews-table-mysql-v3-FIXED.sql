-- Migration: Add Reviews Table (MySQL/MariaDB) - VERSION 3 (CORRECTED FK)
-- Sprint: 7.6 - Personalized Reviews System
-- Database: pxoziy_db1 @ Hetzner
-- Created: 2025-11-08
-- Fixed: Corrected table name in foreign key constraint (POI instead of pois)

-- Create reviews table WITH CORRECT foreign key constraint
CREATE TABLE IF NOT EXISTS reviews (
  ...
  -- Foreign key constraint (FIXED: References POI not pois)
