...
*Laatst bijgewerkt: 29 april 2026 — Fase 17 COMPLEET: 71 inter-agent flows over A2A + Temporal. 46 A2A skills, 2 Temporal workflows. Dashboard fix (materialized agent_status). 303 endpoints, adminPortal.js v3.50.0. 94 BullMQ jobs. 39 agents (37 in registry + 2 virtueel). 71/71 inter-agent flows live. CLAUDE.md v4.75.0. MS v8.24.*
