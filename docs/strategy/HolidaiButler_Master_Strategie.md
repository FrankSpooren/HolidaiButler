...
| **VII** | **Page Builder Enterprise Upgrade + Scale & Launch** | **Block-level UX upgrade (35 blocks), schema.org, container queries, E2E testing, load testing** | **8-12 wkn** | **HOOG** | **🟡 IN PROGRESS (VII-A t/m VII-D COMPLEET, VII-E1 COMPLEET, VII-E2 COMPLEET, VII-E3 COMPLEET, VII-E4 GEPLAND)** |
