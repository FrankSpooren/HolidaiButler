...
const getTheme = (darkMode, compactMode) => createTheme({
  palette: {
...
// Themed App wrapper that responds to settings
function ThemedApp() {
  const [settings, setSettings] = useState(() => {
    const saved = localStorage.getItem('adminSettings');
    return saved ? JSON.parse(saved) : { darkMode: true, compactMode: true };
  });
  ...
  const theme = useMemo(
    () => getTheme(settings.darkMode, settings.compactMode),
