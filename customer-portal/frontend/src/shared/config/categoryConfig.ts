 ...
 * Based on actual database categories (verified 2025-11-07)
 *
...
export const CATEGORY_CONFIG: Record<string, CategoryConfig> = {
  'Active': {
    name: 'Active',
    id: 'active',
    icon: '/assets/category-icons/active.png',  // icons8-bicycle-100.png
    color: 'linear-gradient(135deg, #016193, #1a709d)',
  },
  'Beaches & Nature': {
    name: 'Beaches & Nature',
    id: 'beaches',
    icon: '/assets/category-icons/beaches-nature.png',  // icons8-sun-lounger-100.png
    color: 'linear-gradient(135deg, #b4942e, #bb9e42)',
  },
  'Culture & History': {
    name: 'Culture & History',
    id: 'culture',
    icon: '/assets/category-icons/culture-history.png',  // icons8-library-100.png
    color: 'linear-gradient(135deg, #253444, #3a4856)',
  },
  'Recreation': {
    name: 'Recreation',
    id: 'recreation',
    icon: '/assets/category-icons/recreation.png',  // icons8-jump-96.png
    color: 'linear-gradient(135deg, #354f48, #49605a)',
  },
  'Food & Drinks': {
    name: 'Food & Drinks',
    id: 'food',
    icon: '/assets/category-icons/food-drinks.png',  // Food and drinks.png
    color: 'linear-gradient(135deg, #4f766b, #608379)',
  },
  'Health & Wellbeing': {
    name: 'Health & Wellbeing',
    id: 'health',
    icon: '/assets/category-icons/health-wellbeing.png',  // icons8-blue-heart-100.png
    color: 'linear-gradient(135deg, #004568, #195777)',
  },
  'Shopping': {
    name: 'Shopping',
    id: 'shopping',
    icon: '/assets/category-icons/shopping.png',  // icons8-shopping-basket-100.png
    color: 'linear-gradient(135deg, #b4892e, #bb9442)',
  },
  'Practical': {
    name: 'Practical',
    id: 'practical',
    icon: '/assets/category-icons/practical.png',  // icons8-info-100.png
    color: 'linear-gradient(135deg, #016193, #1a709d)',
  },
  // Accommodation is filtered out but included for completeness
