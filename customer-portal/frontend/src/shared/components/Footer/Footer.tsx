...
/**
 * Footer - Enterprise Footer Component
          ...
          <div className="footer-brand">
            ...
            <div className="footer-social">
              <a
                ...
                aria-label="Facebook"
                onClick={() => analytics.social_link_clicked('facebook')}
              >
              ...
              <a
                ...
                onClick={() => analytics.social_link_clicked('instagram')}
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="social-icon">
              ...
              <a
                ...
                className="social-link"
                aria-label="LinkedIn"
                onClick={() => analytics.social_link_clicked('linkedin')}
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="social-icon">
            ...
            <div className="footer-column">
              ...
              <ul className="footer-link-list">
                {footerLinks.platform.map((link) => (
                  <li key={link.path}>
                    <Link to={link.path} className="footer-link" onClick={() => analytics.footer_link_clicked(link.label)}>{link.label}</Link>
                  </li>
                ))}
              </ul>
            </div>
