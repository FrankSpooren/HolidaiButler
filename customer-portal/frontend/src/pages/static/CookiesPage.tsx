    ...
    <div className="static-page">
      <div className="static-page-hero">
        <div className="static-page-hero-content">
          <h1>{sp?.title || 'Cookiebeleid'}</h1>
          <p>{sp?.subtitle || 'Hoe wij cookies gebruiken op onze website'}</p>
        </div>
      </div>
      ...
      <div className="static-page-content">
        <div className="static-section">
          ...
          <div className="legal-content">
            ...
            <p>
              {sp?.section7Text || 'Voor vragen over ons cookiebeleid kun je contact met ons opnemen via privacy@holidaibutler.com.'}
            </p>
          </div>
        </div>
      </div>
